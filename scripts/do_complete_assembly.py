...
For new projects, use the installed blender_updater package instead:
    blender file.blend --python -m blender_updater -- --config config.json
"""
...
try:
    ...
    # Fallback to original inline implementation if package is not installed
    print("BlenderUpdater package not found. Using inline implementation.")
    print("Consider installing the package: pip install blender-updater")
    print()
